...
(function(root, factory) {
    ...
    JavaScriptHelper.prototype.isUndefined = function(value) {
        return value === undefined;
    };

    JavaScriptHelper.prototype.isDefined = function(value) {
        return value !== undefined;
    };

    JavaScriptHelper.prototype.isObject = function(value) {
        return ((value instanceof Object) || (typeof value === 'object'));
    };

    JavaScriptHelper.prototype.isNumber = function(value) {
        return (typeof value === 'number');
    };

    JavaScriptHelper.prototype.isBoolean = function(value) {
        return (typeof value === 'boolean');
    };
    ...
    JavaScriptHelper.prototype.isArray = function(value) {
        return (value && (value instanceof Array));
    };

    JavaScriptHelper.prototype.isError = function(error) {
        return error instanceof Error;
    };

    JavaScriptHelper.prototype.isDate = function(date) {
        return date instanceof Date;
    };

    JavaScriptHelper.prototype.clone = function(value) {
        var type = typeof value;
        ...
        if (type === 'string' || type === 'number' || type === 'boolean') {
            ...
            if (typeof obj.clone === 'function') {
                ...
                // Do complete clone property
                // TODO [ENYC] Do the cloning
            }
        }
    ...
    JavaScriptHelper.prototype.isNaN = function(value) {
        // See : https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/NaN
        return value !== value;
    };
    ...
    JavaScriptHelper.prototype.equals = function(obj1, obj2) {
        if (obj1 === obj2) {
            return true;
        }
        ...
        if (this.isObject(obj1)) {
            if (this.isFunction(obj1.equals)) {
                return obj1.equals(obj2);
            } else if (this.isFunction(obj1.isEqual)) {
                return obj1.isEqual(obj2);
            }
        }

        if (this.isObject(obj2)) {
            if (this.isFunction(obj2.equals)) {
                return obj2.equals(obj1);
            } else if (this.isFunction(obj2.isEqual)) {
