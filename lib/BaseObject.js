...
function BaseObject() {
  ...
  var myFunctionName = _extractFunctionNameFromInstance(this);
...
Object.defineProperty(BaseObject.prototype, "ignoreSignals", {
  ...
  set: function (ignoreSignals) {
    var currentValue = this.ignoreSignals;
...
function _createGenericFunction_isObjectStateValid(validStates) {
  ...
  return function (state) {
    ...
    var key = _.findKey(validStates, function (obj) {
      return obj === state;
    });
...
Object.defineProperty(BaseObject.prototype, "currentState", {
  ...
  set: function (newState) {
    var currentState = this.properties.currentState;
...
function _defineProperty(constructor, publicName, options) {
  ...
  function _internalSetter(value) {
    try {
      var previousValue = options.get ? options.get.call(this) : undefined;
      var success = options.set.apply(this, arguments);
      if (success === true) {
