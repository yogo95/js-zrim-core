...
/**
 * Test if the object can be started
 * @return {boolean} true if can start, otherwise false
 */
RunnableObject.prototype.canStart = function () {
  return this.currentState === RunnableObject.States.Ready;
};
...
/**
 * Test if the object can be stopped
 * @return {boolean} true if can stop, otherwise false
 */
RunnableObject.prototype.canStop = function () {
  return _.indexOf(
    [
